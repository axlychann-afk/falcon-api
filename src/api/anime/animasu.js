    ...
    try {
      ...
      for (const { src, el } of allIframes) {
        ...
        // ─── Slot 3: Mega.nz ──────────────────────────────
          ...
          isResponsive = false; // Fixed width/height
        }
        ...
        // ─── Slot 4: Desustream ────────────────────────────
          ...
          if (idMatch) {
            embedId = idMatch[1];
            // Decode base64 untuk melihat isinya
            try {
      ...
      res.json({
        ...
        result: {
          ...
          thumbnail: thumbnail,
          url: url,
          // Semua stream dari iframe langsung
          streams: streams,
          // Dropdown server (opsional)
          ...
          // Rekomendasi: cari slot tanpa ADS
